...
import com.wx.YX.payment.utils.ConstantPropertiesUtils;
import com.wx.YX.payment.utils.HttpClient;
...
//			if(null != payMap) return payMap;
            ...
            //向payment_info支付记录表添加记录，目前支付状态：正在支付中
            ...
            int totalFee = paymentInfo.getTotalAmount().multiply(new BigDecimal(0.01)).intValue();
